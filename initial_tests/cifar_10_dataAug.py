...
def main():
    ...
    trained_model = load_model('cifar10_final_dataAug.h5')
    history = trained_model.fit_generator(datagen.flow(trainX, trainY, batch_size=64), epochs=60, validation_data=(testX, testY), verbose=1, callbacks=[LearningRateScheduler(get_lr)])
